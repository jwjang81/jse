...
/*
 ...
 - 문자열 비교시에는 반드시 equals() 메소드 이용
 - new 를 이용하면 help 영역에 새로운 메모리를 할당하고 hashcode 를 생성.
 * */
public class EqualsDemo {
	public static void main(String[] args) {
		// 아래와 같이 생성하는 방식을 리터널 생성 방식이라고 한다.
		String str1 = "abc";
		String str2 = "abc";
		/*
		 * 삼항연산자 폼
		...
		String result3 = (str3 == str4) ? "str3 과 str4 는 같다" : "str3 과 str4 는 다르다";  // 주소값 비교
		String result4 = (str3.equals(str4)) ? "str3 과 str4 는 같다" : "str3 과 str4 는 다르다";  // value값 비교
