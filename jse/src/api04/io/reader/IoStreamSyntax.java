...
/*
 ...
 BufferedInputStream, BufferOutputStream : 버퍼기능 확대
 FileInputStream, FileOutputStream : 내부에 파일을 수정 또는 정보 입출력
 DateInputStream, DataOutputStream : 데이터 타입을 지정해서 입출력
 * */
/*
 문자기반 스트림 : char 가 2byte 이므로 문자데이터에 어려움이
 	발생하는 Byte 기반 스트림을 대처하기 위해 생성함. 문자데이터 전용 스트림
 Reader, Writer
 * */
