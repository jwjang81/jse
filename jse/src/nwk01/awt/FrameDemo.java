...
/*
 ...
 컴포넌트 : 사용자 인터페이스를 구성하는 기본요소
 	버튼, 체크박스, 레이블, 텍스트필드, 리스트, 팝업메뉴와 같은
 	부속품의 총칭. 자바에서는 Component 클래스가 있는데, 모든 컴포넌트는
 	이 Component 의 자손이다.
 컨테이너 : Component 의 후손중에서 Container 라는 클래스가 있는데
 	그 클래스와 자손을 지칭한다. 컨테이너는 컴포넌트를 부착하는 예를 들면
 	윈도우 같은 것을 말하며, 윈도우, 프레임, 패널, 다이얼로그 박스 등이 있다.
...
public class FrameDemo {
	 ...
	 * */	
		...
		// 프레임은 좌표값에 따라 화면에 보여지는데
		// 위 방식처럼 하면 고정된 위치가 아닌, 화면 크기에 따라
